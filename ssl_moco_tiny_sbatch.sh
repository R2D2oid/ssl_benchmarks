...
python3 tinyimage_benchmarks.py --user_name='zahrav' --model_name='MoCo' --data '/home/zahrav/projects/def-jjclark/shared_data/tinyimagenet/data/tiny-imagenet-200'
