...
dataset_train_ssl = NoisyCIFAR10(data_dir,
                                      train=True,
                                      noise_rate=0.0,
                                      noise_type='non',
                                      split_ratio=0.5,
                                      transform=None)
dataset_train_ssl=dataset_train_ssl.pretrn_cifar10

dataset_train_kNN = NoisyCIFAR10(data_dir,
                                      train=True,
                                      noise_rate=0.0,
                                      noise_type='non',
                                      split_ratio=0.5,
                                      transform=None)
dataset_train_kNN=dataset_train_kNN.pretrn_cifar10

dataset_test = NoisyCIFAR10(data_dir,
                                  train=True,
                                  noise_rate=0.0,
                                  noise_type='non',
                                  transform=None)
